...
import control  # Import control library for root locus plotting
...
class PlotApp(tk.Frame):
    ...
    def create_widgets(self):
        ...
        ttk.Label(self, text="Transfer Function:").grid(row=0, column=0, columnspan=2, padx=10, pady=5)
        ttk.Label(self, text=f"Num: {self.num_coeffs}").grid(row=1, column=0, columnspan=2, padx=10, pady=5)
        ttk.Label(self, text=f"Den: {self.den_coeffs}").grid(row=2, column=0, columnspan=2, padx=10, pady=5)
